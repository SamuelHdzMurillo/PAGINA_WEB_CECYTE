<?php
// Versión simplificada del navbar con detección automática de tipo de archivo
function getSimpleBasePath() {
    ...
    // Contar niveles de directorio
    $levels = substr_count($scriptDir, '/');
    if ($levels > 0) {
        return 'PAGINA_WEB_CECYTE/' . str_repeat('../', $levels);
    }
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between h-16">
      ...
      <div class="flex-shrink-0 flex items-center">
        <a href="<?php echo getCorrectPath('index'); ?>">
          <img
      ...
      <div class="hidden sm:flex sm:items-center sm:ml-6">
        ...
        <div class="relative group">
          ...
          >
            <a
              href="<?php echo $basePath; ?>pages_institucion/ubica_tu_plantel.html"
        ...
        <div class="relative group">
          ...
          >
            <a
              href="<?php echo getCorrectSubPath('pages_institucion', 'pagina_historia'); ?>"
              class="block px-4 py-2 text-gray-700 hover:bg-gray-100"
              >Historia, Misión y Visión</a
            >
            <a
              href="<?php echo getCorrectSubPath('pages_institucion', 'planteles_cecyte'); ?>"
              class="block px-4 py-2 text-gray-700 hover:bg-gray-100"
              >Planteles CecyteBCS</a
            >
            <a
              href="<?php echo getCorrectSubPath('pages_institucion', 'planteles_emsad'); ?>"
              class="block px-4 py-2 text-gray-700 hover:bg-gray-100"
              >Planteles Emsad</a
            >
            <a
              href="<?php echo getCorrectPath('directorio_telefonico'); ?>"
              class="block px-4 py-2 text-gray-700 hover:bg-gray-100"
        ...
        <div class="relative group">
          ...
          >
            <a
              href="<?php echo $basePath; ?>pages_oferta_educativa/mantenimiento_equipo_de_computo.html"
              class="block py-2 px-4 text-gray-700 hover:bg-gray-100"
              >Soporte y Mantenimiento de equipo de cómputo</a
            >
            <a
              href="<?php echo $basePath; ?>pages_oferta_educativa/programacion.html"
              class="block py-2 px-4 text-gray-700 hover:bg-gray-100"
              >Programación</a
            >
            <a
              href="<?php echo $basePath; ?>pages_oferta_educativa/ventas.html"
              class="block py-2 px-4 text-gray-700 hover:bg-gray-100"
              >Ventas</a
            >
            <a
              href="<?php echo $basePath; ?>pages_oferta_educativa/ecoturismo.html"
              class="block py-2 px-4 text-gray-700 hover:bg-gray-100"
              >Ecoturismo</a
            >
            <a
              href="<?php echo $basePath; ?>pages_oferta_educativa/produccion_industrial_de_alimentos.html"
              class="block py-2 px-4 text-gray-700 hover:bg-gray-100"
              >Producción industrial de alimentos</a
            >
            <a
              href="<?php echo $basePath; ?>pages_oferta_educativa/mantenimiento_industrial.html"
              class="block py-2 px-4 text-gray-700 hover:bg-gray-100"
              >Mantenimiento Industrial</a
            >
            <a
              href="<?php echo $basePath; ?>pages_oferta_educativa/servicios_de_hoteleria.html"
              class="block py-2 px-4 text-gray-700 hover:bg-gray-100"
        ...
        <div class="relative group">
          ...
          >
            <a
              href="<?php echo $basePath; ?>pages_alumnos/becas.html"
              class="block py-2 px-4 text-gray-700 hover:bg-gray-100"
              >Becas</a
            >
            <a
              href="<?php echo $basePath; ?>pages_alumnos/prog_acompanamiento.html"
              class="block py-2 px-4 text-gray-700 hover:bg-gray-100"
              >Programa de Acompañamiento</a
            >
            <a
              href="<?php echo $basePath; ?>pages_alumnos/requisitos_de_ingreso.html"
              class="block py-2 px-4 text-gray-700 hover:bg-gray-100"
        ...
        <div class="relative group">
          ...
          >
            <a
              href="<?php echo $basePath; ?>pages_normatividad/manuales_de_procedimientos.html"
              class="block py-2 px-4 text-gray-700 hover:bg-gray-100"
              >Manuales de Procedimientos</a
            >
            <a
              href="<?php echo $basePath; ?>pages_normatividad/manuales_de_org.html"
              class="block py-2 px-4 text-gray-700 hover:bg-gray-100"
        ...
        <div class="relative group">
          ...
          >
            ...
            >
            <a
              href="<?php echo $basePath; ?>pages_transparencia/cuenta_publica.html"
              class="block py-2 px-4 text-gray-700 hover:bg-gray-100"
              >Cuenta Pública</a
            >
            <a
              href="<?php echo $basePath; ?>pages_transparencia/ley_diciplina.html"
              class="block py-2 px-4 text-gray-700 hover:bg-gray-100"
  ...
  <div class="sm:hidden hidden" id="mobile-menu">
    ...
    <div class="block">
      ...
      <div class="hidden" id="institucion-submenu">
        <a
          href="<?php echo $basePath; ?>pages_institucion/pagina_historia.html"
          class="block px-8 py-2 text-gray-700 hover:bg-gray-100"
          >Historia, Misión y Visión</a
        >
        <a
          href="<?php echo $basePath; ?>pages_institucion/planteles_cecyte.html"
          class="block px-8 py-2 text-gray-700 hover:bg-gray-100"
          >Planteles CecyteBCS</a
        >
        <a
          href="<?php echo $basePath; ?>pages_institucion/planteles_emsad.html"
          class="block px-8 py-2 text-gray-700 hover:bg-gray-100"
          >Planteles Emsad</a
        >
        <a
          href="<?php echo $basePath; ?>directorio_telefonico.html"
          class="block px-8 py-2 text-gray-700 hover:bg-gray-100"
          >Directorio Telefónico</a
        >
      </div>
